...
void display() {
    ...
    //================ LAPTOP =====================
      ...
      float trapTopY = ovalCenterY + radiusY + 0.02f;
      ...
      float shiftX = -0.15f;  // move trapezoid left
      float shiftY = 0.12f;   // move trapezoid up
      ...
      float bottomTrapBottomLeftX = bottomTrapTopLeftX - (bottomLength - topLength);
      float bottomTrapBottomRightX = bottomTrapTopRightX;
      ...
      glBegin(GL_POLYGON);
          ...
          glVertex2f(bottomTrapBottomRightX, bottomTrapBottomY);
      ...
      // Scalable height for black rectangle
      float rectHeight2 = 0.015f;  // Adjust this to make it taller/thinner

      // Bottom side vertices of the trapezoid (already computed)
      float rectLeftX = bottomTrapBottomLeftX;
      float rectRightX = bottomTrapBottomRightX;
      float rectTopY = bottomTrapBottomY;       // flush with base trapezoid bottom
      float rectBottomY = rectTopY - rectHeight2;  // rectangle extends downward

      // Draw thin black rectangle flush with base trapezoid
      glColor3f(0.0f, 0.0f, 0.0f);  // Black color

      glBegin(GL_POLYGON);
          glVertex2f(rectLeftX, rectTopY);     // top left
          glVertex2f(rectRightX, rectTopY);    // top right
          glVertex2f(rectRightX, rectBottomY); // bottom right
          glVertex2f(rectLeftX, rectBottomY);  // bottom left
      glEnd();
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Geometric Scene");
